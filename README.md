...
- [x] Vitals Sensing module — on-device HR (camera PPG) + breathing rate (microphone), Monitor tab with recent-readings store, in-triage confidence gate (see `docs/VITALS_SENSING.md`, ADR-017; full suite 309 pass)
